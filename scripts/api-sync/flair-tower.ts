...
export const WEBSITE = "https://www.flairtower.com";

const URL = "https://www.flairtower.com/floorplans";
...
async function main() {
  ...
  const gallery = await request("https://www.flairtower.com/photogallery");
