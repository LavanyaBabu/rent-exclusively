...
export const WEBSITE = "https://www.asburyplaza.com";

const URL = "https://www.asburyplaza.com/floorplans";
...
async function main() {
  ...
  const gallery = await request("https://www.asburyplaza.com/photogallery", {
    bodyTimeout: 0,
    headersTimeout: 0
  });
