...
export const WEBSITE = "https://wolfpointwest.com";

export const URL =
  "https://wolfpointwest.urbanapt.com/api/listings/?per_page=50&listing_type=rentals&property_type=residential&page=1&sort=price&sort_dir=asc&childId=nestio-iframe-pym&iframe=true&initialWidth=727&parentTitle=Wolf+Point+West+Apartments+%7C+The+best+of+living+downtown+in+River+North,+Chicago&parentUrl,=https:%2F%2Fwolfpointwest.com%2F%23";
...
async function main() {
  ...
  const gallery = await request(WEBSITE);
