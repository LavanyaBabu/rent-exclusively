...
export const WEBSITE = "https://www.liveatthemason.com";

const URL = "https://www.liveatthemason.com/floorplans";
    ...
    .each((i, el) => {
      ...
      entry
        ...
        .each((j, unitElement) => {
          ...
          const priceVar = unit.root().find(`[data-selenium-id='Floorplan${counter}Rent']`).text();
