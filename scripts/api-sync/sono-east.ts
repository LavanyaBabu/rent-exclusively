...
export const WEBSITE = "https://www.sonoeast.com";

export const URL = "https://www.sonoeast.com/CmsSiteManager/callback.aspx?act=Proxy/GetFloorPlans";
...
async function main() {
  ...
  const gallery = await request("https://www.sonoeast.com/Gallery.aspx");
